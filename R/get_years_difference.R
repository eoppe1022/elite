...
#' @param to The reference date. For finding a player's draft eligibility, typically "2018-09-15", or whatever the year of the NHL draft.
#' @examples 
#' get_years_difference("2000-09-15", "2018-09-15")
#' 
#' # My birthday -- don't forget it!
#' get_years_difference("1995-10-22", "2018-08-24")
#' 
#' @export
#' @import dplyr
#' 
